                  ...
                  uint32_t width, uint32_t height)
{
    ...
    for (uint32_t crow = 0; crow < chroma_h; crow++) {
        ...
        uint8_t *out = dst_uv + (size_t) crow * width; /* 2 bytes per chroma pair */
                  ...
                  uint32_t width, uint32_t height)
{
    ...
    for (uint32_t crow = 0; crow < chroma_h; crow++) {
        const uint8_t *in_u = src_u + (size_t) crow * chroma_w;
        const uint8_t *in_v = src_v + (size_t) crow * chroma_w;
        uint8_t *out = dst_uv + (size_t) crow * width;
